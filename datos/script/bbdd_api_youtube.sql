...
-- 
-- object: bbdd_api_youtube | type: DATABASE --
-- DROP DATABASE IF EXISTS bbdd_api_youtube;
--CREATE DATABASE bbdd_api_youtube;
-- ddl-end --
...
-- ALTER TABLE public.video DROP CONSTRAINT IF EXISTS topic_fk CASCADE;
ALTER TABLE public.video ADD CONSTRAINT topic_fk FOREIGN KEY (id_topic)
